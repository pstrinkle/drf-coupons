...
class CouponListSettingsTests(BasicTest):
    ...
    def test_cant_list_coupon_if_not_in_group(self):
        """
        Verify the user can restrict permissions.
        """

        with self.settings(ROOT_URLCONF='coupons.urls'):
            with self.settings(COUPON_PERMISSIONS={'LIST': ['group_a']}):
    ...
    def test_can_list_coupon_if_group_empty(self):
        """
        Verify the user can restrict permissions.
        """

        with self.settings(ROOT_URLCONF='coupons.urls'):
            with self.settings(COUPON_PERMISSIONS={'LIST': []}):
    ...
    def test_can_list_coupon_if_in_group(self):
        """
        Verify the user can restrict permissions.
        """
