# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2017-01-09 02:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('binding_email', models.EmailField(blank=True, max_length=256, null=True)),
                ('repeat', models.IntegerField(default=-1)),
                ('binding_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
